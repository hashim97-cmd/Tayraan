...
const FlightSearchForm: React.FC<any> = ({
  ...
  const router = useRouter()
    ...
    const handleSubmit = async (event: React.FormEvent) => {
        ...
        console.log(origin,destination,departureDate, "searching")
        ...
        router.push(
            `/en/flight-search?origin=${encodeURIComponent(origin)}&destination=${encodeURIComponent(destination)}&departureDate=${encodeURIComponent(departureDate.toISOString())}${returnDate ? `&returnDate=${encodeURIComponent(returnDate.toISOString())}` : ''}&class=${encodeURIComponent(flightClass)}&adult=${travelers.adults}&child=${travelers.children}&lapinfant=${travelers.infants}`
        );
